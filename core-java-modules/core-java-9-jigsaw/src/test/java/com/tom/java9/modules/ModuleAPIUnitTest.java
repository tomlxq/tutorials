...
public class ModuleAPIUnitTest {
    ...
    public void givenModuleName_whenBuildingModuleDescriptor_thenBuilt() {
        Builder moduleBuilder = ModuleDescriptor.newModule("tom.base");

        ModuleDescriptor moduleDescriptor = moduleBuilder.build();

        assertThat(moduleDescriptor.name(), is("tom.base"));
    }
    ...
    public void whenExportingPackage_thenPackageIsExported() {
        Module updatedModule = module.addExports("com.tom.java9.modules", javaSqlModule);

        assertTrue(updatedModule.isExported("com.tom.java9.modules"));
    }

    @Test
    public void whenOpeningAModulePackage_thenPackagedIsOpened() {
        Module updatedModule = module.addOpens("com.tom.java9.modules", javaSqlModule);

        assertTrue(updatedModule.isOpen("com.tom.java9.modules", javaSqlModule));
    }
