 ...
 * <p>
 * This simple program loads 3 million {@link String} instances into a {@link HashMap}
 * object before making an explicit call to the garbage collector using <code>System.gc()</code>.
 * <p>
 * Finally, it removes 2 million of the {@link String} instances from the {@link HashMap}.
