...
@ComponentScan({"com.tom.persistence", "com.tom.jpa.dao"})
@EnableJpaRepositories(basePackages = "com.tom.jpa.dao")
public class PersistenceTransactionalTestConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"com.tom.persistence.model"});
