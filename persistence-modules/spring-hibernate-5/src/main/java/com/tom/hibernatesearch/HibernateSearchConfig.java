package com.tom.hibernatesearch;
...
@EnableJpaRepositories(basePackages = {"com.tom.hibernatesearch"})
@ComponentScan({"com.tom.hibernatesearch"})
public class HibernateSearchConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"com.tom.hibernatesearch.model"});
