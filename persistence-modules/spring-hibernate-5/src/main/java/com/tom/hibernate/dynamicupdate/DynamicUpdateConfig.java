package com.tom.hibernate.dynamicupdate;
...
@EnableJpaRepositories(basePackages = {"com.tom.hibernate.dynamicupdate"})
@ComponentScan({"com.tom.hibernate.dynamicupdate"})
public class DynamicUpdateConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"com.tom.hibernate.dynamicupdate.model"});
