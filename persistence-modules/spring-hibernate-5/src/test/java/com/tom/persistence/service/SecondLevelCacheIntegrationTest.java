...
import com.tom.hibernate.cache.model.Bar;
import com.tom.hibernate.cache.model.Foo;
import com.tom.hibernate.cache.service.FooService;
...
public class SecondLevelCacheIntegrationTest {
    ...
    public final void givenEntityIsLoaded_thenItIsCached() {
        ...
        final int size = CacheManager.ALL_CACHE_MANAGERS.get(0).getCache("com.tom.hibernate.cache.model.Foo").getSize();
