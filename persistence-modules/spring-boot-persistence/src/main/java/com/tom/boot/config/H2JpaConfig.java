...
@Configuration
@EnableJpaRepositories(basePackages = {"com.tom.boot.repository", "com.tom.repository"})
...
public class H2JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"com.tom.boot.domain"});
