...
public class RssFeedView extends AbstractRssFeedView {
    ...
    protected void buildFeedMetadata(Map<String, Object> model, Channel feed, HttpServletRequest request) {
        feed.setTitle("Tom RSS Feed");
        feed.setDescription("Learn how to program in Java");
        feed.setLink("http://www.tom.com");
    }
    ...
    protected List<Item> buildFeedItems(Map<String, Object> model, HttpServletRequest request,
        ...
        entryOne.setLink("http://www.tom.com/junit-5-test-annotation");
        ...
        entryTwo.setLink("http://www.tom.com/jetty-java-programmatic");
        ...
        entryThree.setLink("http://www.tom.com/java-flyweight");
        ...
        entryFour.setLink("http://www.tom.com/java-multi-swarm-algorithm");
        ...
        entryFive.setLink("http://www.tom.com/mongodb-tagging");
        ...
        entrySix.setLink("http://www.tom.com/java-singleton-double-checked-locking");
        ...
        entrySeven.setLink("http://www.tom.com/dagger-2");
