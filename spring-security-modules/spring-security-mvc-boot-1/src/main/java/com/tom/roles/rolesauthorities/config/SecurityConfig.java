package com.tom.roles.rolesauthorities.config;

import com.tom.roles.rolesauthorities.CustomAuthenticationProvider;
import com.tom.roles.rolesauthorities.persistence.UserRepository;
...
@Configuration
@ComponentScan(basePackages = {"com.tom.rolesauthorities"})
@EnableWebSecurity
