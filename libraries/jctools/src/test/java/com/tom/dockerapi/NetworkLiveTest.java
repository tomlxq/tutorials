...
public class NetworkLiveTest {
    ...
    public void whenCreatingNetwork_thenRetrieveResponse() {
        ...
        // when
        CreateNetworkResponse networkResponse = dockerClient.createNetworkCmd().withName("tomDefault").withDriver("bridge").exec();
    ...
    public void whenCreatingAdvanceNetwork_thenRetrieveResponse() {
        ...
        // when
        CreateNetworkResponse networkResponse = dockerClient.createNetworkCmd().withName("tomAdvanced").withIpam(new Ipam().withConfig(new Ipam.Config().withSubnet("172.36.0.0/16").withIpRange("172.36.5.0/24"))).withDriver("bridge").exec();
