package com.tom.reactive.cors.annotated.controllers;
...
@CrossOrigin(value = {"http://allowed-origin.com"}, allowedHeaders = {"Tom-Another-Allowed"}, maxAge = 900)
@RestController
...
public class CorsOnClassController {
    ...
    @CrossOrigin(allowedHeaders = {"Tom-Allowed"})
    ...
    @CrossOrigin(exposedHeaders = {"Tom-Exposed"})
    ...
    @CrossOrigin(allowedHeaders = {"Tom-Allowed", "Tom-Other-Allowed"}, exposedHeaders = {"Tom-Allowed", "Tom-Exposed"}, maxAge = 3600)
