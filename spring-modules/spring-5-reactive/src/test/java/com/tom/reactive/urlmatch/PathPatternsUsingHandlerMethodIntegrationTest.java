package com.tom.reactive.urlmatch;

import com.tom.reactive.Spring5ReactiveApplication;
import com.tom.reactive.controller.PathPatternController;
...
public class PathPatternsUsingHandlerMethodIntegrationTest {
    ...
    public void givenHandlerMethod_whenURLWithMultiplePathVariablesInSameSegment_then200() {
        ...
        client.get()
                ...
                .is2xxSuccessful()
                .expectBody()
                .equals("Two variables are var1=tom and var2=tutorial");
    }
