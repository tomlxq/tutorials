package com.tom.reactive.responseheaders;
...
public class ResponseHeaderLiveTest {
    ...
    private static final String SERVICE_SINGLE_RESPONSE_HEADER = "Tom-Example-Header";
    private static final String SERVICE_FILTER_RESPONSE_HEADER = "Tom-Example-Filter-Header";
