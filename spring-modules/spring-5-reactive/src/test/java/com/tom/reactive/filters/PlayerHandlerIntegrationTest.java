package com.tom.reactive.filters;
...
public class PlayerHandlerIntegrationTest {
    ...
    @Test
    public void whenPlayerNameIsTom_thenWebFilterIsApplied() {
        EntityExchangeResult<String> result = webTestClient.get().uri("/players/tom")
                .exchange()
                .expectStatus().isOk()
                .expectBody(String.class)
                .returnResult();

        assertEquals(result.getResponseBody(), "tom");
