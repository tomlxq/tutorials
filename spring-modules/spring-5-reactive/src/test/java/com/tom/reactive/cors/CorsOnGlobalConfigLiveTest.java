...
public class CorsOnGlobalConfigLiveTest {
    ...
    public void whenPreflightAllowedDeleteEndpoint_thenObtainResponseWithCorsHeaders() {
        ResponseSpec response = client.options()
                ...
                .header("Access-Control-Request-Headers", "Tom-Not-Allowed, Tom-Allowed, Tom-Other-Allowed")
                .exchange();
        ...
        response.expectHeader()
                .valueEquals("Access-Control-Allow-Headers", "Tom-Allowed, Tom-Other-Allowed");
        response.expectHeader()
