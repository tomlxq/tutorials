...
import com.tom.resttemplate.web.dto.Foo;
...
import static com.tom.client.Consts.APPLICATION_PORT;
...
public class RestTemplateBasicLiveTest {
    ...
    public void givenFooService_whenPatchExistingEntity_thenItIsUpdated() {
        ...
        final long id = createResponse.getBody().getId();
    ...
    ClientHttpRequestFactory getClientHttpRequestFactory1() {
        final int timeout = 5;
