package com.tom.produceimage.controller;
...
public class DataProducerController {
    ...
    byte[] getImage() throws IOException {
        final InputStream in = getClass().getResourceAsStream("/com/tom/produceimage/image.jpg");
    ...
    byte[] getFile() throws IOException {
        final InputStream in = getClass().getResourceAsStream("/com/tom/produceimage/data.txt");
        return IOUtils.toByteArray(in);
    }
